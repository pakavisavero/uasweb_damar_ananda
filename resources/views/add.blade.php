...
<body>
    <div class="container mt-4">
        <form action="{{ '/submit-karyawan' }}" method="post">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Nama Karyawan</label>
            ...
            <div class="mb-3">
                ...
                <input name="departemen" type="text" class="form-control" id="exampleFormControlInput1">
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary mb-4">Add Karyawan</button>
        </form>
    </div>
